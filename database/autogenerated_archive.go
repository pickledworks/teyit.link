...
// MetaImageEq is an autogenerated method
// nolint: dupl
func (qs ArchiveQuerySet) MetaImageEq(metaImage string) ArchiveQuerySet {
	return qs.w(qs.db.Where("meta_image = ?", metaImage))
}

// MetaImageIn is an autogenerated method
// nolint: dupl
func (qs ArchiveQuerySet) MetaImageIn(metaImage ...string) ArchiveQuerySet {
	if len(metaImage) == 0 {
		qs.db.AddError(errors.New("must at least pass one metaImage in MetaImageIn"))
		return qs.w(qs.db)
	}
	return qs.w(qs.db.Where("meta_image IN (?)", metaImage))
}

// MetaImageNe is an autogenerated method
// nolint: dupl
func (qs ArchiveQuerySet) MetaImageNe(metaImage string) ArchiveQuerySet {
	return qs.w(qs.db.Where("meta_image != ?", metaImage))
}

// MetaImageNotIn is an autogenerated method
// nolint: dupl
func (qs ArchiveQuerySet) MetaImageNotIn(metaImage ...string) ArchiveQuerySet {
	if len(metaImage) == 0 {
		qs.db.AddError(errors.New("must at least pass one metaImage in MetaImageNotIn"))
		return qs.w(qs.db)
	}
	return qs.w(qs.db.Where("meta_image NOT IN (?)", metaImage))
}
...
func (u ArchiveUpdater) SetID(ID uint) ArchiveUpdater {
	u.fields[string(ArchiveDBSchema.ID)] = ID
	return u
}
...
// SetMetaImage is an autogenerated method
// nolint: dupl
func (u ArchiveUpdater) SetMetaImage(metaImage string) ArchiveUpdater {
	u.fields[string(ArchiveDBSchema.MetaImage)] = metaImage
	return u
}
